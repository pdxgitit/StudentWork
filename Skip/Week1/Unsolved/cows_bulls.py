...
# every digit that the user guessed correctly in the correct place, they have a
# “cow”. For every digit the user guessed correctly in the wrong place is a
# “bull.” Every time the user makes a guess, tell them how many “cows” and
